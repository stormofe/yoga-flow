...
export default function Register() {
        ...
        const validateLogin = (login: string): boolean => {
            ...
            return login.length >= minLength && regex.test(login);
          }
        ...
        const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
            ...
            if (!state.password && e.target.name === 'login') {
                setLoginError('Login is required');
            } else if (!validatePassword(state.password) && e.target.name === 'login') {
                setLoginError('Invalid characters or your login is too short');
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            ...
                            <div>
                                ...
                                <input onChange={handleChange} type="text" name="login" id="login" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Enter your login" required/>
